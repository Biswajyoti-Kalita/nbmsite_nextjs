  ...
  return (
    <div className="min-h-screen h-full flex flex-col items-center justify-center bg-white">
      ...
      <div className="bg-[#162ABF] flex flex-col items-center justify-center w-full pt-[50px] lg:pt-0">
        <section
          className="w-full p-4 pb-[0px] mt-[64px] md:mt-[64px] md:mt-0 md:p-[80px] grid grid-cols-1 md:grid-cols-2 gap-[80px] items-start justify-start relative lg:max-w-[1440px]"
          id="home"
        >
