  ...
  return (
    <div className="min-h-screen h-full flex flex-col items-center justify-center bg-white">
      ...
      <div className="bg-[#162ABF] flex flex-col items-center justify-center w-full pt-[50px] lg:pt-0">
        <section
          className="w-full p-4 pb-[0px] mt-[64px] md:mt-[64px] md:mt-0 md:p-[80px] lg:pb-0 grid grid-cols-1 md:grid-cols-2 gap-[80px] items-start justify-start relative lg:max-w-[1440px]"
          id="home"
        >
          <div className="w-full flex flex-col items-start justify-start gap-4 h-auto lg:h-[430px] px-4 lg:px-0">
            <Breadcrumb pages={[{ name: "Why Audio", link: "/why_audio" }]} />
      ...
      <div className="w-full flex flex-col items-center justify-center">
        <div className="w-full max-w-[1440px]">
          <section
            className="w-full p-4 mt-[64px] md:mt-0 md:py-[96px] md:px-[80px] flex flex-col gap-[64px] items-center justify-between relative lg:max-w-[1440px]"
            id="home"
          >
              ...
              <div className="w-full flex flex-col lg:flex-row items-start justify-center gap-[40px] lg:gap-[64px]">
                ...
                <div className="w-full flex flex-col items-start justify-center gap-[16px] order-1 lg:order-2">
                  <div className="w-full flex flex-col items-start justify-center py-[4px] gap-[8px]">
                    <h1 className="font-semibold uppercase text-[16px] leading-[24px] text-[#F11F68] tracking-[-0.02em]">
                      Results You Can Measure
                    </h1>
                  </div>
                  <div className="w-full flex flex-col items-start justify-center gap-[32px]">
                    <div className="w-full">
                      <p className="font-semibold text-[#262626] text-[24px] lg:text-[32px] leading-[32px] lg:leading-[40px] tracking-[0em]">
            ...
            <div className="w-full flex flex-col lg:flex-row items-start justify-center gap-[16px] lg:gap-[24px]">
              <div className="w-full flex flex-col items-start justify-between border-t border-[#D2D2D2] pt-[32px] h-[138px] lg:h-[188px] max-w-[410px] gap-[16px] lg:gap-[24px]">
                <h1 className="font-semibold text-[#000000] text-[34px] lg:text-[42px] leading-[42px] lg:leading-[48px] tracking-[0em]">
                  65%
                </h1>
                <p className="font-semibold text-[#262626] text-[16px] lg:text-[20px] leading-[24px] lg:leading-[28px] tracking-[0em]">
          ...
          <section className="w-full flex flex-col items-start justify-start bg-[#FFFEFF] gap-[46px] lg:gap-[64px] py-[84px] lg:py-[96px] px-[16px] lg:px-[80px]">
            <h1 className="font-bold text-[34px] capitalize lg:text-[42px] leading-[42px] lg:leading-[50px] tracking-[-0.02em] gradient-text">
            ...
            <div className="w-full flex flex-col lg:flex-row items-start justify-start gap-[16px]">
              <div className="w-full lg:w-auto">
                <div className="w-full flex flex-col items-start gap-[16px] justify-between rounded-[16px] p-[20px] lg:p-[40px] bg-[#FFEDFB] h-[146px] lg:h-[275px] max-w-[415px]">
                  <h1 className="font-semibold w-full  text-[#F11F68] text-[34px] lg:text-[42px] leading-[42px] lg:leading-[50px] tracking-[-0.02em]">
                    584.1 M
                  </h1>
                  <p className="font-semibold text-[#262626] text-[16px] lg:text-[20px] leading-[24px] lg:leading-[28px] tracking-[0em]">
              ...
              <div className="flex flex-col items-start justify-start gap-[16px]">
                ...
                <div className="w-full flex flex-col items-start gap-[16px] justify-between rounded-[16px] p-[20px] lg:p-[40px] bg-[#FFEDFB] h-[146px] lg:h-[275px] max-w-[415px]">
                  ...
                  <div className="w-full flex flex-col items-start justify-center gap-[4px]">
                    ...
                    <h6 className="font-normal text-[#F11F68] text-[16px] lg:text-[20px] leading-[24px] lg:leading-[28px] tracking-[0em]">
              ...
              <div className="w-full flex flex-col lg:flex-row items-start justify-start gap-[20px] overflow-hidden">
                <div className="w-full max-w-[756px] h-full rounded-[16px] p-[32px] lg:p-[64px] flex gap-[10px] relative">
                  ...
                  <div className="w-full flex flex-col items-start justify-start gap-[40px] z-10">
                    <h1 className="font-bold text-[34px] lg:text-[42px] leading-[42px] lg:leading-[50px] tracking-[-0.02em] text-[#FFFFFF]">
