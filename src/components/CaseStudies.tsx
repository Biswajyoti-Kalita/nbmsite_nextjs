        ...
        <div className="rounded-2xl bg-[#FFFEFF] w-full md:w-[740px] h-auto md:h-[300px] border-1 border-[#E8E8E8] grid grid-cols-1 md:grid-cols-2 items-start justify-between">
          <div className="flex flex-col items-start p-[10px] justify-start gap-[16px] border-[#E8E8E8] border-r-1 h-full rounded-2xl">
            ...
            <div className="flex flex-row items-center justify-center gap-[16px] w-full">
              <img src={caseStudy.left_image} alt="bel" className="w-[180px] h-[150px] object-contain" />
            </div>
          </div>
            ...
            <div className="flex flex-col items-start justify-start gap-[19px]">
              ...
              <div className=" border-[#E8E8E8] border-t-1 p-4 w-full">
                <div className="flex flex-row items-center justify-between gap-[11px] w-full">
                  {
                    caseStudy.analytics.map((analytics: any, index:number) => (
                        ...
                        <div key={index} className="w-[130px]">
                            ...
                            <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 12.2923H3.26667C5.50688 12.2923 6.62698 12.2923 7.48263 11.8563C8.23528 11.4728 8.8472 10.8609 9.23069 10.1082C9.66667 9.25259 9.66667 8.13249 9.66667 5.89228L9.66667 1.62561M9.66667 1.62561L6.33333 4.95894M9.66667 1.62561L13 4.95894" stroke="#0FB89F" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>                            
                            </h4>
          ...
          >
            ...
            <span>
              <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1 13.959L13 1.95898M13 1.95898H5M13 1.95898V9.95898" stroke="url(#paint0_linear_1858_6122)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <defs>
