...
export default function BrandsScroller() {
  ...
  const splideOptions1 = {
    ...
    drag: 'free' as const,
    gap: 30,
    width: splideWidth < 700 ? splideWidth : splideWidth - 300,
    autoWidth: true,
    autoScroll: {
      speed: 0.8,
      pauseOnHover: false,
  ...
  return (
    <section
      id="brands"
      className="w-full ml-[16px] rounded-xl p-4 md:p-8 mt-8 md:mt-12 md:flex flex-col items-center justify-center"
    >
      <div
