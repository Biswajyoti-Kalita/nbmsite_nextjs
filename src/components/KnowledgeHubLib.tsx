...
export default function KnowledgeHubLib() {
  ...
  const [docType, setDocType] = useState("Advertiser");
    ...
    <section className="w-full flex flex-col justify-start items-start lg:flex-row bg-[#FFFEFF] text-[#262626] py-[96px] px-4 lg:px-[80px] gap-[64px]">
      <div className="w-full flex flex-col lg:flex-row justify-between items-start max-w-[1280px] gap-[32px] gap-[64px]">
        <div className="w-full flex flex-col justify-between items-start gap-[20px] max-w-full lg:max-w-[280px]">
          ...
          <select
            className=" lg:hidden w-full border-[#D0D5DD] border-[1px] rounded-[8px] p-[10px]"
            onChange={(e) => setSelectedType(e.target.value)}
          >
            {types.map((type, index) => (
              <option key={index} value={type} selected={selectedType === type}>
                {type}
              </option>
            ))}
          </select>
        ...
        <div className="w-full flex flex-col justify-between items-start gap-[32px]">
          <div className="w-full flex flex-row justify-start items-start gap-[10px]">
            {["Advertiser", "Podcaster", "Publisher"].map((type, index) => (
              <span
                key={index}
                className={`py-[8px] px-[16px] rounded-[44px] border-[2px] ${
                  docType == type
                    ? " bg-[#FFEDFB]  border-[#F11F68] text-[#F11F68] "
                    : "border-[#344054] text-[#344054]"
                }  gap-[6px]  text-[16px] leading-[24px] font-semibold`}
          ...
          <div className="w-full flex flex-col justify-between items-start gap-[10px] p-0 lg:px-[32px] rounded-[16px] bg-[#F8F9FA] h-full">
            <div className="w-full flex flex-col justify-between items-start gap-[32px] lg:gap-[64px] py-[12px] rounded-[16px]">
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 justify-between items-start gap-[20px]">
                ...
                {(selectedType == "Guide" || selectedType == "View All") && docType == "Advertiser" && (
                      ...
                      <div className="w-full flex flex-col justify-between items-start gap-[14px]">
                        <div className="w-full flex flex-col justify-between items-start gap-[16px]">
                          ...
                          <h2 className="font-normal text-[14px] leading-[22px] tracking-[0em] text-[#344054]">
                            Podcast Advertising and Show Strategy for the
                            YouTube Era{" "}
                          </h2>
                        </div>
                      </div>
                      <Link
                        href="/assets/files/NEW! mics to screen - Next Audio.pdf"
                        target="_blank"
                      >
                        <GradientButton
                          text="Download"
                ...
                {(selectedType == "Video" || selectedType == "View All") && docType == "Advertiser" && (
                  <div className="w-full max-w-[426px] flex flex-col justify-between items-start gap-[32px] bg-[#FFFEFF] border border-[#E8E8E8] rounded-[16px]">
                    <div className="w-full relative justify-between items-start gap-[20px] w-[426px] h-[305px] rounded-[16px]">
                      <Image
                    ...
                    <div className="w-full flex flex-col justify-between items-start p-[24px] min-h-[262px]  gap-[24px] ">
                      ...
                      <Link
                        href="https://www.youtube.com/watch?v=bv1w2R1vBBM&t=4s"
                        target="_blank"
                      >
                        <GradientButton
                          text="Download"
                ...
                {(selectedType == "Graphic" || selectedType == "View All") && docType == "Advertiser" && (
                  <div className="w-full max-w-[426px] flex flex-col justify-between items-start gap-[32px] bg-[#FFFEFF] border border-[#E8E8E8] rounded-[16px]">
                    ...
                    <div className="w-full flex flex-col justify-between items-start p-[24px] min-h-[262px] gap-[24px] ">
                      <div className="w-full flex flex-col justify-between items-start gap-[14px]">
                        <div className="w-full flex flex-col justify-between items-start gap-[16px]">
                          ...
                          <h2 className="font-normal text-[14px] leading-[22px] tracking-[0em] text-[#344054]">
                            A proven framework to write short podcast ads that
                            deliver awareness and results
                          </h2>
                        </div>
                      </div>
                      <Link
                        href="/assets/files/Next Audio Anatomy of an effective podcast ad.pdf"
                        target="_blank"
                      >
                        <GradientButton
                          text="Download"
                    ...
                    <div className="w-full relative justify-between items-start gap-[20px] w-[426px] h-[305px] rounded-[16px] bg-black">
                      ...
                      <div className="absolute z-20 top-[163px] left-[24px] flex flex-row justify-center items-center gap-[8px]">
                        <span className="text-white text-[28px] leading-[34px] font-extrabold ">
                          Why Podcast Advertising <br />
                          Belongs in Every Media <br />
                          Plan
                        </span>
                      </div>
                    </div>
                    <div className="w-full flex flex-col justify-between items-start p-[24px] min-h-[262px]  gap-[24px] ">
                      <div className="w-full flex flex-col justify-between items-start gap-[14px]">
                        <div className="w-full flex flex-col justify-between items-start gap-[16px]">
                          ...
                          <h2 className="font-normal text-[14px] leading-[22px] tracking-[0em] text-[#344054]">
                            Buying podcast ads. Reach premium audiences no other
                            media can touch
                          </h2>
                        </div>
                      </div>
                      <Link
                        href="/assets/files/Next Audio Why Podcasts belong on media plans .pdf"
                        target="_blank"
                      >
                        <GradientButton
                          text="Download"
                    ...
                    <div className="w-full flex flex-col justify-between items-start p-[24px] min-h-[262px]  gap-[24px] ">
                      <div className="w-full flex flex-col justify-between items-start gap-[14px]">
                        <div className="w-full flex flex-col justify-between items-start gap-[16px]">
                          ...
                          <h2 className="font-normal text-[14px] leading-[22px] tracking-[0em] text-[#344054]">
                            A guide to podcast listener personas and how to
                            match your brand to their mindset
                          </h2>
                        </div>
                      </div>
                      <Link
                        href="/assets/files/Next Audio Audience profile targeting.pdf"
                        target="_blank"
                      >
                        <GradientButton
                          text="Download"
                    ...
                    <div className="w-full flex flex-col justify-between items-start p-[24px] min-h-[262px]  gap-[24px] ">
                      <div className="w-full flex flex-col justify-between items-start gap-[14px]">
                        <div className="w-full flex flex-col justify-between items-start gap-[16px]">
                          ...
                          <h2 className="font-normal text-[14px] leading-[22px] tracking-[0em] text-[#344054]">
                            Agency Guide: How to integrate podcasts into your Q4
                            media plans
                          </h2>
                        </div>
                      </div>
                      <Link
                        href="/assets/files/2025 - Q4 Media planners guide (1).pdf"
                        target="_blank"
                      >
                        <GradientButton
                          text="Download"
                ...
                {(selectedType == "Guide" || selectedType == "View All") && docType == "Advertiser" && (
                  <div className="w-full max-w-[426px] flex flex-col justify-between items-start gap-[32px] bg-[#FFFEFF] border border-[#E8E8E8] rounded-[16px]">
                    ...
                    <div className="w-full flex flex-col justify-between items-start p-[24px] min-h-[262px]  gap-[24px] ">
                      ...
                      <Link
                        href="/assets/files/Introduction to Digital Audio Advertising .pdf"
                        target="_blank"
                      >
                        <GradientButton
                          text="Download"
